...
import {ChevronBarLeft, ChevronBarRight, List, TextLeft} from "react-bootstrap-icons";
...
const Sider = React.forwardRef<HTMLDivElement, SiderProps>(
    (
        ...
        const renderSider = () => {
            ...
            const iconObj = {
                expanded: reverseArrow ? <ChevronBarRight /> : <ChevronBarLeft />,
                collapsed: reverseArrow ? <ChevronBarLeft /> : <ChevronBarRight />,
            };
